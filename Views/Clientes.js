        ...
        return(
            <Container>
              ...
              <Left>
                ...
                <Body>
                  <Title style={{ fontFamily: 'sans-serif-condensed', fontWeight: 'bold', fontStyle: 'italic', color: '#f224b6'}}>Clientes</Title>
                </Body>
                <Right>
                  <Button transparent>
                    <Icon name='menu' />
                ...
                <Content style={{flex: 1,backgroundColor: '#88ccfc'}}>
                  <Text>{"\n"}</Text>
                  <Text>{"\n"}</Text>
                  <Card style={{flex: 0}}>
                    <CardItem>
                      <Left>
                        ...
                        <Body>
                          ...
                          <Text note>Registrar nuevo cliente</Text>
                        </Body>
                      </Left>
                    </CardItem>
                    <CardItem>
